...
|АД (Мастер) | Проводит stand-up совещание | 60 мин | 
|АД (Мастер) | Проводит демонстрацию результатов спринта владельцу продукта и другим заинтересованным лицам | 60 мин | 
|БА (Тестировщик) | Разбивает задачу истории на подзадачи - тесты | 180 мин |  
|БА (Тестировщик) | Разрабатывает процедуры - тесты и тестовые наборы данных | 120 мин |  
|БА (Тестировщик) | Разрабатывает и отлаживает процедуры - тесты и тестовые наборы данных | 90 мин |  
|ВН (Дизайнер) | Разбивает эскиз интерфейса для сайта при отображении на мобильном устройстве | 60 мин | 60 мин
|ВН (Дизайнер) | Разрабатывает дизайн интерфейса для сайта при отображении на мобильном устройстве | 120 мин | 90 мин
|ВН (Дизайнер) | Разрабатывает прототип интерфейса для сайта при отображении на мобильном устройстве | 120 мин |  
|ВН (Дизайнер) | Разрабатывает и отлаживает процедуры - страницы, позволяющие выполнять тесты в интерактивном режиме | 90 мин |  
|КО (Тех.писатель) | Создает техническую документацию для всех подзадач, требующих программной реализации | 120 мин |  
|КО (Тех.писатель) | Корректирует или делает новые описания для всех разработанных процедур | 60 мин |  
|КО (Тех.писатель) | Разрабатывает требуемые описания всех разработанных процедур, тестов и тестовых наборов данных | 60 мин |  
|НИ (Архитектор) | Разбивает задачу истории на подзадачи - процедуры | 60 мин | 60 мин
|НИ (Архитектор) | Определяет дополнительные требования к выполнению задач | 30 мин |  
|НИ (Архитектор) | Принимает решение по всем выявленных несоответствиям требованиям | 30 мин |  
|ПП (Программист) | Разрабатывает алгоритмы выполнения всех подзадач, требующих программной реализации | 60 мин | 30 мин
|ПП (Программист) | Разрабатывает процедуры - обработчики и генераторы тестовых наборов данных | 180 мин |  
|ПП (Программист) | Разрабатывает и отлаживает процедуры - генераторы тестовых наборов данных | 120 мин |  
|РП (Владелец продукта) | Регистрирует участников проекта | 90 мин | 30 мин
|РП (Владелец продукта) | Принимает решение по всем возникающим проблемам | 60 мин |  
|РП (Владелец продукта) | Принимает решение об успешности спринта, дает общую оценку работы команды и дает предложения по всем индивидуальным оценкам | 60 мин |  
...
|СП (Аналитик) | Выполняет все разработанные тесты, регистрирует все выявленные несоответствия требованиям | 120 мин
...
|--|--
|Зайти через логин и пароль читателя|✅
|Выбрать книгу|✅
|Получить данные о местоположении книги|✅
